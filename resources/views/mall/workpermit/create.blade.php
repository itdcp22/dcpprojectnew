      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-lg-2">
            ...
            <input class="form-control datepicker" id="datepicker1" name="wp_to_date" placeholder="dd-mm-yyyy" required>
          ...
          <div class="col-lg-2">
            <input type="time" class="form-control" id="validationCustom02" name="wp_from_time"
      ...
      <div class="form-group">
        <p class="bg-warning text-white"><strong>Description of Work</strong>
          <textarea class="form-control" name="wp_description" rows="3" id="comment"
            placeholder="Enter work description in detail" required></textarea>
        </p>
      </div>
