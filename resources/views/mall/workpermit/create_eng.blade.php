...
<section class="content">
    <div class="container-fluid">
        <form class="needs-validation" name="myform" id="myform" novalidate method="post"
            action="{{ route('mall.workpermit.store') }}" enctype="multipart/form-data" autocomplete="off"
            autofill="off">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <input type="text" class="form-control" id="wp_manager" name="wp_manager"
                            value="{{ $tenant->tm_contact}}" placeholder="Enter manager name">
                    </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        ...
                        <input class="form-control datepicker" id="datepicker" name="wp_from_date"
                            placeholder="dd-mm-yyyy" tabindex="6" value="{{ old('wp_from_date') }}" required>
                   ...
                   uiLibrary: 'bootstrap4'
                    ...
                    <div class="col-lg-2">
                        ...
                        <input class="form-control datepicker" id="datepicker1" name="wp_to_date"
                            placeholder="dd-mm-yyyy" tabindex="7" value="{{ old('wp_to_date') }}" required>
                 ...
                 format: 'dd-mm-yyyy',
                   uiLibrary: 'bootstrap4'
                    ...
                    <div class="col-lg-2">
                        <input type="time" class="form-control timepicker" id="wp_from_time" name="wp_from_time"
                            tabindex="8" placeholder="Enter time to" value="{{ old('wp_from_time') }}">
              ...
              $('.timepicker').timepicker({
                    ...
                    <div class="col-lg-2">
                        <input type="time" class="form-control" id="wp_to_time" name="wp_to_time"
                            placeholder="Enter time to" value="{{ old('wp_to_time') }}" tabindex="9">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="d-flex mb-3">
                        ...
                        <div class="p-2 flex-fill" options><input type="checkbox" value="Carpentry"
                                name="wp_category[]">Carpentry
                        </div>
                        <div class="p-2 flex-fill "><input type="checkbox" value="Fit-Out" name="wp_category[]">Fit-Out
                        </div>
                        <div class="p-2 flex-fill "><input type="checkbox" value="Painting"
                                name="wp_category[]">Painting
                        </div>
                        <div class="p-2 flex-fill "><input type="checkbox" value="Promotion"
                                name="wp_category[]">Promotion
                        </div>
                        <div class="p-2 flex-fill "><input type="checkbox" value="Plumbing"
                                name="wp_category[]">Plumbing
                        </div>
                        <div class="p-2 flex-fill "><input type="checkbox" value="Hot Work" name="wp_category[]">Hot
                            Work
                        </div>
                        <div class="p-2 flex-fill "><input type="checkbox" value="Electrical / HVAC"
                                name="wp_category[]">Electrical
                            /
                            HVAC</div>
                        <div class="p-2 flex-fill "><input type="checkbox" value="Stock Taking"
                                name="wp_category[]">Stock
                            Taking
                        </div>
        ...
        requiredCheckboxes.attr('required', 'required');
            ...
            <div class="form-group">
                ...
                <ol>
                    ...
                    <li>For HOT work permits, valid fire extingusher and first aid kit has to be stored at work place
                    </li>
                </ol>
