    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Sales Details
            <a href="{{ route('gift.giftsale.create') }}" class="btn btn-primary btn-sm">Add New</a></h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
              ...
              <tr>
                ...
                <td>
                  ...
                  <form onsubmit="return confirm('Do you really want to delete?');"
                    action="{{ route('foh.booking.destroy',$c->id) }}" method="POST">
                    {{ csrf_field() }}
