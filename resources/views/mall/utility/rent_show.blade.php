                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col text-left align-text-bottom">
                                <p class="align-text-bottom"><b> {{ $utility->ui_type }}
                                        from
                                                    ...
                                                    <table class="table table-bordered">
                                                            <thead>
                                                                  <tr>
                                                                ...
                                                                        <th class="w-20 text-center">From
                                                                </th>
                                                                <th class="w-20 text-center">To</th>
                                                                       
                                                                ...
                                                                        <th class="w-20 text-center">Rent Per Day</th>  
                                                        ...
                                                            <tbody>    
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    {{ date('d-m-Y', strtotime($utility->ui_from_date)) }}
                                                                </td>
                                                                <td class="text-right">
                                                                    {{ date('d-m-Y', strtotime($utility->ui_to_date)) }}
                                                                </td>
                                                                <td class="text-right">{{ $utility->ui_rent_days }}</td>
                                                                <td class="text-right">
                                                                    {{number_format($utility->ui_rent_per_day,3) }}</td>
                                                                <td class="text-right">
                                                                    {{number_format($utility->ui_amount,3) }}</td>
                                                            ...
                                                                  </tr>
                                                            <tr>
                                                                <td colspan="6" class="text-right">VAT 5%</td>
                                                                <td class="text-right">
                                                                    {{number_format($utility->ui_vat,3) }}</td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="font-weight-bold text-right">
                                                                    {{number_format($utility->ui_netamount,3) }}
                                                                </td>
                                                            </tr>


                                                            <tr>
                                                                <td colspan="9" class="font-weight-bold text-left">
                                                                    Amount in Words: <?php
                ...
                <div class="col text-center">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col text-left">
                                <label class="col text-center" for="">Prepared By:
                                    {{ $utility->ui_created_name }}</label>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col text-left">
                                ...
                                <p>Bank Name &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;: Ahli Bank SAOG
                                    <br>
                                    Account Name &nbsp; &nbsp;&nbsp; &nbsp;: Tamani Global Development and Investment
                                    L.L.C <br>
