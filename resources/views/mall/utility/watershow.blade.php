                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col text-left align-text-bottom">
                                <p class="align-text-bottom"><b>Service: Being charges for {{ $utility->ui_type }}
                                        consumed from
                                                    ...
                                                    <table class="table table-bordered">
                                                            <thead>
                                                                  <tr>
                                                                ...
                                                                        <th class="w-20 text-center">Opening Reading
                                                                </th>
                                                                        <th class="w-20 text-center">Closing Reading
                                                                </th>
                                                                        <th class="w-20 text-center">Consumption</th>
                                                                        <th class="w-20 text-center">Unit Rate</th>
                                                                        <th class="w-20 text-center">Water Amount</th>
                                                                        <th class="w-20 text-center">Sewage Amount</th>
                                                        ...
                                                            <tbody>    
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    {{number_format($utility->ui_rate,3) }}</td>
                                                                <td class="text-right">
                                                                    {{number_format($utility->ui_amount,3) }}</td>

                                                                <td class="text-right">
                                                                    {{number_format($utility->ui_sewage,3) }}
                                                                </td>

                                                                <td class="text-right">
                                                                    {{number_format($utility->ui_amount + $utility->ui_sewage,3) }}
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="8" class="font-weight-bold text-right">
                                                                    Grand Total</td>
