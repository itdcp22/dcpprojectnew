      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">
            <h2 class="text-success">Laravel Dynamically Add or Remove input fields using JQuery Demo -
              Tutsmake.com</h2>
          </div>
          <div class="card-body">
              ...
              <form name="add_name" id="add_name">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered" id="dynamic_field">
                    <tr>
                      <td><input type="text" name="title[]" placeholder="Enter title" class="form-control name_list" /
                          id="title"></td>
