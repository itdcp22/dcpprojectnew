    ...
    <form class="needs-validation" name="myform" id="myform" novalidate method="post"
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <input type="text" class="form-control" id="validationCustom01" name="tb_cust_name"
              placeholder="Enter School / Company Name" required>
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <input type="text" class="form-control" id="validationCustom02" name="tb_cust_addr"
              placeholder="Enter School / Company Address" required>
            <div class="clear-fix"></div>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-lg-3">
            <input type="time" class="form-control" id="validationCustom02" name="tb_time"
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <select class="custom-select" name="tb_addon1_price" id="tb_addon1_price" onchange="calc4()">
                <option value="" selected disabled hidden>Please select</option>
                @foreach($addon as $c)
            ...
            <td>
              <input type="text" class="form-control text-right" id="addon1_amount" name="addon1_amount" placeholder=""
                disabled>
            </td>
          </tr>
